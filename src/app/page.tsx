      ...
      <div className="flex flex-col lg:flex-row min-h-screen w-full">
        ...
        <div className="w-full lg:w-[65%] xl:w-[70%] px-6 py-12 md:px-12 lg:px-24 xl:px-32 lg:py-24 z-10 flex flex-col items-start justify-start">
          <main id="content" className="max-w-3xl w-full">
            ...
            {/* 01. ABOUT SECTION */}
            <section id="about" className="mb-8 scroll-mt-16 md:mb-10" aria-label="About me">
            ...
            <section id="experience" className="mb-8 scroll-mt-16 md:mb-10" aria-label="Experience">
              ...
              <div className="mt-12">
                <a className="inline-flex items-center gap-1.5 font-semibold text-indigo-400 hover:text-indigo-300 transition-colors group text-sm md:text-base" 
            ...
            <section id="projects" className="mb-8 scroll-mt-16 md:mb-10" aria-label="Projects">
            ...
            <section id="blog" className="mb-8 scroll-mt-16 md:mb-10" aria-label="Writing">
              ...
              <Link href="/blog" className="inline-flex items-center gap-1.5 font-semibold text-indigo-400 hover:text-indigo-300 transition-colors group text-sm md:text-base">
            ...
            <section id="education" className="mb-8 scroll-mt-16 md:mb-10" aria-label="Education">
